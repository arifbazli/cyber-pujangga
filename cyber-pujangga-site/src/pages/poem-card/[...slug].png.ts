...
export async function GET(context: APIContext) {
  ...
  const host = context.site ? new URL(context.site).host : "cyber-pujangga.pages.dev";

  const formattedDate = new Date(pubDate).toLocaleDateString(locale === "ms" ? "ms-MY" : "en-US", {
    year: "numeric",
    month: "short",
    day: "numeric",
  });
